# ZYBO Z7 用 RTCL-P3S7-MIPI グローバルシャッター高速度カメラ HUB-75E 動作サンプル
...
```bash
cd projects/zybo_z7/zybo_z7_rtcl_p3s7_hub75e/syn/tcl
make
```
...
`projects/zybo_z7/zybo_z7_rtcl_p3s7_hub75e/syn/vivado2024.2/zybo_z7_rtcl_p3s7_hub75e.xpr`
...
`zybo_z7_rtcl_p3s7_hub75e.runs/impl_1/zybo_z7_rtcl_p3s7_hub75e.bit`
...
`projects/zybo_z7/zybo_z7_rtcl_p3s7_hub75e/app` ディレクトリに、先ほど PC の Vivado で作成した `zybo_z7_rtcl_p3s7_hub75e.bit` をコピーしておいてください。

#### C++版の実行

```bash
cd projects/zybo_z7/zybo_z7_rtcl_p3s7_hub75e/app
make run_cpp
```
...
```bash
cd projects/zybo_z7/zybo_z7_rtcl_p3s7_hub75e/app/cpp
make remote_run
```
...
```bash
cd projects/zybo_z7/zybo_z7_rtcl_p3s7_hub75e/app/rust
make remote_run
```
