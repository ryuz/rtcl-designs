...
module hub75_driver
        #(
            ...
            parameter   int             XADDR_BITS       = $clog2(WIDTH)            ,
            parameter   type            xaddr_t          = logic [XADDR_BITS-1:0]   ,
            parameter   int             YADDR_BITS       = $clog2(N*HEIGHT)         ,
            parameter   type            yaddr_t          = logic [YADDR_BITS-1:0]   ,
        ...
        (
            ...
            input   var xaddr_t             mem_xaddr   ,
            input   var xaddr_t             mem_yaddr   ,
