...
module ft601_pll_MOD (lock, clkout0, clkout1, mdrdo, clkin, reset, pllpwd, mdclk, mdopc, mdainc, mdwdi);
...
//defparam PLLA_inst.CLKOUT1_PE_COARSE = 1; // 90
//defparam PLLA_inst.CLKOUT1_PE_FINE = 6;

defparam PLLA_inst.CLKOUT1_PE_COARSE = 5;   // 270
