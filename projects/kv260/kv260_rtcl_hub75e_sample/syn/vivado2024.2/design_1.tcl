...
proc create_root_design { parentCell } {
  ...
  set out_clk50 [ create_bd_port -dir O -type clk out_clk50 ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {m_axi4} \
...
\
  ...
  assign_bd_address -offset 0xA0000000 -range 0x10000000 -with_name SEG_m_axi4l_peri_Reg -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs m_axi4l/Reg] -force
