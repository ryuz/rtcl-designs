...
module kv260_rtcl_p3s7_centroid
        #(
    ...
    image_processing
        ...
        u_image_processing
            (
                ...
                .m_centroid_valid   (centroid_valid         ),

                .m_moment_m00       (moment_m00             ),
                .m_moment_m10       (moment_m10             ),
                .m_moment_m01       (moment_m01             ),
    ...
    // logger
    logic  [1:0][63:0]  centroid_log_data;
    assign centroid_log_data[0] = 64'(centroid_x);
    assign centroid_log_data[1] = 64'(centroid_y);
    ...
    jelly3_data_logger_fifo
        ...
        u_data_logger_fifo_of
            (
                ...
                .s_data         (centroid_log_data  ),
                .s_valid        (centroid_valid     ),
                .s_ready        (                   ),
    ...
    logic  [2:0][63:0]  moment_log_data;
    assign moment_log_data[0] = 64'(moment_m00);
    assign moment_log_data[1] = 64'(moment_m10);
    assign moment_log_data[2] = 64'(moment_m01);
    ...
    */
    ...
    jelly3_uart
            #(
                ...
                .DIVIDER_BITS       (8                  ),
                .INIT_DIVIDER       (8'(25-1)           ),  // 200,000,000Hz / 1,000,000bps / 8 = 25
                .DEVICE             ("RTL"              ),
                .SIMULATION         ("false"            ),
                .DEBUG              ("false"            )
            )
